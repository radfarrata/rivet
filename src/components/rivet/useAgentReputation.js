...
export const TIERS = [
  { name: 'Platinum', min: 2000, stars: 5, color: 'text-cyan-600', bg: 'bg-cyan-50', ring: 'border-cyan-200' },
...
export function tierFor(score) {
  return TIERS.find(t => score >= t.min) || { name: 'Unrated', stars: 0, color: 'text-[#65676b]', bg: 'bg-[#f0f2f5]', ring: 'border-[#e4e6eb]', min: 0 };
}
