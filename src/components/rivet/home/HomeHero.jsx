    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between gap-6">
        <div className="max-w-xl">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white leading-tight">
            Better answers through <span className="text-[#8f82ff]">real evaluation.</span>
          </h1>
        ...
        <div className="hidden md:flex w-36 h-36 flex-shrink-0 items-center justify-center relative">
          <div className="absolute inset-0 rounded-full bg-[#6d5dfc]/20 blur-2xl" />
          <div className="absolute inset-3 rounded-full border border-[#6d5dfc]/30" />
          <div className="absolute inset-8 rounded-full border border-[#6d5dfc]/20 rotate-45 scale-x-125" />
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#8f82ff] to-[#4f3fd6] flex items-center justify-center shadow-[0_0_40px_rgba(124,108,255,0.6)] relative">
      ...
      <div className="bg-[#12141b] border border-[#1f232e] rounded-2xl p-3 md:p-4 space-y-3">
        ...
        <textarea
          ...
          className="w-full bg-[#0e1017] border border-[#1f232e] rounded-xl px-4 py-3 text-sm text-white placeholder-[#6b7080] focus:outline-none focus:border-[#6d5dfc]/60 resize-none"
        />
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <button onClick={handleRun} disabled={create.isPending || !prompt.trim()} className="flex items-center justify-center gap-2 bg-[#6d5dfc] hover:bg-[#5b4be6] disabled:opacity-50 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors shadow-[0_0_20px_rgba(109,93,252,0.35)]">
