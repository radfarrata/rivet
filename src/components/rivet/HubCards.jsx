  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div onClick={() => onNavigate?.('projects')} className="rounded-2xl border border-[#e4e6eb] bg-[#ffffff] p-6 hover:bg-[#f0f2f5] transition-colors cursor-pointer">
        <div className="w-12 h-12 rounded-xl bg-[#1877f2]/10 flex items-center justify-center mb-4"><Hammer className="w-6 h-6 text-[#1877f2]" /></div>
        ...
        <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#1877f2] hover:underline">Explore Build Hub <ArrowRight size={14} /></span>
      </div>
      <div onClick={() => onNavigate?.('training-hub')} className="rounded-2xl border border-[#e4e6eb] bg-[#ffffff] p-6 hover:bg-[#f0f2f5] transition-colors cursor-pointer">
        <div className="w-12 h-12 rounded-xl bg-[#1877f2]/10 flex items-center justify-center mb-4"><Brain className="w-6 h-6 text-[#1877f2]" /></div>
        ...
        <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#1877f2] hover:underline">Explore Training Hub <ArrowRight size={14} /></span>
      </div>
    </div>
  );
}