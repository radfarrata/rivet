...
export default function EvaluationTaskForm({ currentUser, onCreated }) {
  ...
  return (
    <div className="bg-[#12141b] rounded-2xl border border-[#1f232e] p-5 space-y-3">
      ...
      <textarea value={form.criteria} onChange={e => set('criteria', e.target.value)} placeholder="Evaluation criteria — how should responses be judged?" rows={2} className={`${inputCls} resize-none`} />
      <div>
