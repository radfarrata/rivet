  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-md transition-shadow">
      <div className="flex items-start gap-3 mb-3">
        ...
        {post.status === 'pending_approval' && <span className="text-[10px] bg-amber-100 text-amber-600 px-2 py-0.5 rounded-full font-medium flex-shrink-0">Pending</span>}
      </div>
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <button onClick={() => onUpvote?.(post)} className="flex items-center gap-1 text-xs text-gray-400 hover:text-violet-600 transition-colors">
